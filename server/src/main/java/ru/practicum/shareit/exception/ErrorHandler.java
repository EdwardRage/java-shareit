...
public class ErrorHandler {
    ...
    public ErrorResponse handleConditionsNotMet(final ConditionsNotMetException e) {
        ...
        return new ErrorResponse("ConditionsNotMetException", e.getMessage());
    }
    ...
    public ErrorResponse handleNotAvailable(final NotAvailableException e) {
        ...
        return new ErrorResponse("NotAvailableException",e.getMessage());
    }
    ...
    public ErrorResponse handleDataIntegrityViolationException(final DataIntegrityViolationException e) {
        ...
        return new ErrorResponse("DataIntegrityViolationException", e.getMessage());
    }
