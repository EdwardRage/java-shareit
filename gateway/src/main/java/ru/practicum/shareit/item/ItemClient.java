...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> update(long itemId, ItemForUpdateDto itemDto, long userId) {
        return patch("/" + itemId, userId, itemDto);
    }

    public ResponseEntity<Object> createComment(long itemId, long authorId, CommentRequest commentRequest) {
